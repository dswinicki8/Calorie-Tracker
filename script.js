...
function foodLogger() {
    ...
    $.ajax({
        ...
        .then(function (response) {
            ...
            console.log(response.hits[1].fields.item_name)
            console.log(response.hits[1].fields.nf_calories)
            console.log(response.hits[2].fields.item_name)
            console.log(response.hits[2].fields.nf_calories)
            console.log(response.hits[3].fields.item_name)
            console.log(response.hits[3].fields.nf_calories)
            console.log(response.hits[4].fields.item_name)
            console.log(response.hits[4].fields.nf_calories)
            console.log(response.hits[5].fields.item_name)
            console.log(response.hits[5].fields.nf_calories)
            console.log(response.hits[6].fields.item_name)
            console.log(response.hits[6].fields.nf_calories);
